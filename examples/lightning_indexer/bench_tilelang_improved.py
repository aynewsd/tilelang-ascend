"""msprof op target script: TileLang lightning_indexer (dynamic shape, improved).

Under msprof op:
    msprof op --application="python bench_tilelang_improved.py --S2 4096 --n-runs 20" \
              --warm-up=5 --launch-count=10 --output=./msprof_output/tilelang_improved
"""
...
def main():
    parser = argparse.ArgumentParser(description="lightning_indexer TileLang improved target for msprof op")
